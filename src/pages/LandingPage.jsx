...
const LandingPage = () => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Main Landing Content - Reduced top spacing */}
      <div className="min-h-screen flex flex-col items-center justify-start text-center px-6 pt-8">
        <div className="p-8 rounded-2xl backdrop-blur-md max-w-5xl w-full shadow-xl">
          <div className="flex flex-col items-center text-center">
            ...
            <img
              src={Logo}
              alt="Nexync Logo"
              className="h-48 w-auto my-2 drop-shadow-lg transition-transform duration-500 hover:scale-105"
            />
          ...
          <h2 className="font-helvetica mt-6 text-xl md:text-2xl font-light text-white leading-relaxed">
            An All-In-One Project Management Platform Built For The Next Generation Of Work.
          </h2>

          {/* Action Buttons */}
          <div className="flex flex-col md:flex-row justify-center gap-10 pt-8 w-full">
            {/* Register column */}
            <div className="flex flex-col items-center w-56">
              <span className="mb-3 text-base text-[#cdd9ee]">
                First Time Visiting?
