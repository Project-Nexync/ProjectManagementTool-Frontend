...
export default function Navbar({ user }) {
  ...
  return (
    <nav className="bg-transparent shadow-md fixed top-0 left-0 w-full z-10">
      <div className="max-w-7xl mx-2 px-4 sm:px-6 lg:px-8 flex justify-between h-18 items-center">
        {/* Logo */}
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 font-helvetica hidden md:flex space-x-20 text-[#C4C6C8]">
          <a href="#" className="hover:text-[#1C89EF]">home</a>
          <a href="#" className="hover:text-[#1C89EF]">dashboard</a>
          <a href="#" className="hover:text-[#1C89EF]">features</a>
          <a href="#" className="hover:text-[#1C89EF]">about</a>
        </div>
