...
export default function ProjectCardsGrid({ search }) {
  ...
  const filtered = search
    ...
    : projects;
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 md:gap-6 flex-1 px-2 md:px-6 lg:px-8 xl:px-16 2xl:px-32 max-w-screen-xl mx-auto">
      {filtered.map((p, i) => (
        <ProjectCard
          key={i}
          {...p}
